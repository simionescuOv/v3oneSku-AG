...
- **MultiTag: Auto-Expand si Stilizare Contor**:
  - Implementat \searchOverride\ �n \MultiTagSheet.jsx\ pentru a expanda automat folderul 'Fixate' �n timpul c�ut�rii, f�r� a suprascrie preferin?a salvat� a utilizatorului.
  - Actualizat UI-ul pentru num�rul de tag-uri de pe fiecare r�nd (aplicat font alb, �ngro?at) pentru a cre?te lizibilitatea.
